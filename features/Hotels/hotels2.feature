Feature: Project 2
    ...
    # npx wdio wdio.conf.js --cucumberOpts.tagExpression '@TC-29'
    # allure generate --clean ./report/allure-results/
    # npx wdio wdio.conf-cbtest.js --spec ./features/Hotels/hotels2.feature
    # npx wdio wdio.conf.js --spec ./features/Hotels/hotels2.feature